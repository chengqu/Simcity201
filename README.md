...
####Eric Liu: 
	 	...
	 	-Implemented the traffic light system in transportation so that walkers will not cross the intersection 			unless the lights are green. The lights will change every 10 seconds, but there is a slight delay in 		sending the information back to the worker. This delay causes some people to rush across the street even though 		it is red. It sort of imitates real life.
