...
public interface Customer {
	...
	public abstract void msgHereIsYourBill(float charge);

	/**
	 * 
	 * this is the message that the cashier calls to tell the customer if the bill is good or not 
	 * 
	 * @param moneyOwed
	 */
	
	public abstract void msgBillRecieved(float moneyOwed);
	 ...
	 * @param charge
	 * 
	 * This is a message sent from the waiter
	 */
