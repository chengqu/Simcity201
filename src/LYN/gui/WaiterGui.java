...
public class WaiterGui implements Gui {
	...
	public WaiterGui(Waiter c, RestaurantGui gui){ //HostAgent m) {
		agent = c;
		xPos = myhome;
		yPos = 10;
		xDestination = myhome;
	...
	public void draw(Graphics2D g) {
		...
		if(agent.getClass().equals(WaiterProducer.class)){
			WaiterProducer temp = (WaiterProducer) agent;
			if (temp.a==1){
		...
		else if(agent.getClass().equals(WaiterAgent.class)){
